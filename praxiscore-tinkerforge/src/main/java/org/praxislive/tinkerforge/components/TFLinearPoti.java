 ...
 *
 */
@GenerateTemplate(TFLinearPoti.TEMPLATE_PATH)
public class TFLinearPoti extends TFCodeDelegate {

    final static String TEMPLATE_PATH = "resources/linear_poti.pxj";

    // PXJ-BEGIN:body


    @TinkerForge BrickletLinearPoti poti;
